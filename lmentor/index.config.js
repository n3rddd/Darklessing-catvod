...
var index_config_default = {
  ...
  danmu: {
    urls: [
      { address: "http://175.44.42.89:9300/87654321", name: "默认1" },
      { address: "https://fjj0417.dpdns.org/87654321", name: "默认2" },
      { address: "http://120.5.2.184:8098/87654321", name: "默认3" },
      { address: "http://47.107.188.112:6008/87654321", name: "默认4" },
      { address: "http://ecs.dysobo.cn:9321/87654321", name: "默认5" },
      { address: "https://dmapi.8188911.xyz/87654321", name: "默认6" },
      { address: "https://danmu.bona1984.com:99/87654321", name: "默认7" }
    ],
    autoPush: true,
  ...
  webdav: [
    ...
    {
      name: "七米兰",
      server: "https://al.chirmyram.com:443",
      path: "/dav",
      username: "alist",
      password: "alist",
      enabled: true
