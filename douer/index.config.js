...
var index_config_default = {
  ...
  tgchannel: {wydwpzy,zyywpzy,sgkwpzy,yunpanuc,ucquark},
  sites: {
    list: []
  },
  pans: {
  ...
  danmu: {
    urls: [
           { address: "https://fjj0417.dpdns.org/87654321", name: "默认服务器1" },
           { address: "https://313236.xyz/87654321", name: "默认服务器2" }
          ],
    autoPush: true
  },
  t4: {
    list: [http://zhangqun1818.serv00.net:6628/]
  },
  cms: {
    list: [https://ghp.xptvhelper.link/https://raw.githubusercontent.com/fangkuia/XPTV/main/CMS/XPAV.json]
  },
  alist: [
    {
      name: "🐉神族九帝",
